...
export const RegisterForActorKilled = (akForm: Form | null | undefined): void =>
  sn.RegisterForActorKilled(akForm);
export const UnregisterForActorKilled = (
  akForm: Form | null | undefined
): void => sn.UnregisterForActorKilled(akForm);
...
export const RegisterForActorReanimateStart = (
  akForm: Form | null | undefined
): void => sn.RegisterForActorReanimateStart(akForm);
export const UnregisterForActorReanimateStart = (
  akForm: Form | null | undefined
): void => sn.UnregisterForActorReanimateStart(akForm);

export const RegisterForActorReanimateStop = (
  akForm: Form | null | undefined
): void => sn.RegisterForActorReanimateStop(akForm);
export const UnregisterForActorReanimateStop = (
  akForm: Form | null | undefined
): void => sn.UnregisterForActorReanimateStop(akForm);
...
export const RegisterForActorResurrected = (
  akForm: Form | null | undefined
): void => sn.RegisterForActorResurrected(akForm);
export const UnregisterForActorResurrected = (
  akForm: Form | null | undefined
): void => sn.UnregisterForActorResurrected(akForm);
...
export const RegisterForBookRead = (akForm: Form | null | undefined): void =>
  sn.RegisterForBookRead(akForm);
export const UnregisterForBookRead = (akForm: Form | null | undefined): void =>
  sn.UnregisterForBookRead(akForm);
...
export const RegisterForCellFullyLoaded = (
  akForm: Form | null | undefined
): void => sn.RegisterForCellFullyLoaded(akForm);
export const UnregisterForCellFullyLoaded = (
  akForm: Form | null | undefined
): void => sn.UnregisterForCellFullyLoaded(akForm);
...
export const RegisterForCriticalHit = (akForm: Form | null | undefined): void =>
  sn.RegisterForCriticalHit(akForm);
export const UnregisterForCriticalHit = (
  akForm: Form | null | undefined
): void => sn.UnregisterForCriticalHit(akForm);
...
export const RegisterForDisarmed = (akForm: Form | null | undefined): void =>
  sn.RegisterForDisarmed(akForm);
export const UnregisterForDisarmed = (akForm: Form | null | undefined): void =>
  sn.UnregisterForDisarmed(akForm);
...
export const RegisterForDragonSoulGained = (
  akForm: Form | null | undefined
): void => sn.RegisterForDragonSoulGained(akForm);
export const UnregisterForDragonSoulGained = (
  akForm: Form | null | undefined
): void => sn.UnregisterForDragonSoulGained(akForm);
...
export const RegisterForItemHarvested = (
  akForm: Form | null | undefined
): void => sn.RegisterForItemHarvested(akForm);
export const UnregisterForItemHarvested = (
  akForm: Form | null | undefined
): void => sn.UnregisterForItemHarvested(akForm);
...
export const RegisterForLevelIncrease = (
  akForm: Form | null | undefined
): void => sn.RegisterForLevelIncrease(akForm);
export const UnregisterForLevelIncrease = (
  akForm: Form | null | undefined
): void => sn.UnregisterForLevelIncrease(akForm);
...
export const RegisterForLocationDiscovery = (
  akForm: Form | null | undefined
): void => sn.RegisterForLocationDiscovery(akForm);
export const UnregisterForLocationDiscovery = (
  akForm: Form | null | undefined
): void => sn.UnregisterForLocationDiscovery(akForm);
...
export const RegisterForObjectGrab = (akForm: Form | null | undefined): void =>
  sn.RegisterForObjectGrab(akForm);
export const UnregisterForObjectGrab = (
  akForm: Form | null | undefined
): void => sn.UnregisterForObjectGrab(akForm);
...
export const RegisterForObjectLoaded = (
  akForm: Form | null | undefined,
  formType: number
): void => sn.RegisterForObjectLoaded(akForm, formType);
export const UnregisterForObjectLoaded = (
  akForm: Form | null | undefined,
  formType: number
): void => sn.UnregisterForObjectLoaded(akForm, formType);
export const UnregisterForAllObjectsLoaded = (
  akForm: Form | null | undefined
): void => sn.UnregisterForAllObjectsLoaded(akForm);
...
): void => sn.RegisterForQuest(akForm, akQuest);
export const UnregisterForQuest = (
  akForm: Form | null | undefined,
  akQuest: Quest | null | undefined
): void => sn.UnregisterForQuest(akForm, akQuest);
export const UnregisterForAllQuests = (akForm: Form | null | undefined): void =>
  sn.UnregisterForAllQuests(akForm);
...
export const RegisterForQuestStage = (
  akForm: Form | null | undefined,
  akQuest: Quest | null | undefined
): void => sn.RegisterForQuestStage(akForm, akQuest);
export const UnregisterForQuestStage = (
  akForm: Form | null | undefined,
  akQuest: Quest | null | undefined
): void => sn.UnregisterForQuestStage(akForm, akQuest);
export const UnregisterForAllQuestStages = (
  akForm: Form | null | undefined
): void => sn.UnregisterForAllQuestStages(akForm);
...
export const RegisterForShoutAttack = (akForm: Form | null | undefined): void =>
  sn.RegisterForShoutAttack(akForm);
export const UnregisterForShoutAttack = (
  akForm: Form | null | undefined
): void => sn.UnregisterForShoutAttack(akForm);
...
export const RegisterForSkillIncrease = (
  akForm: Form | null | undefined
): void => sn.RegisterForSkillIncrease(akForm);
export const UnregisterForSkillIncrease = (
  akForm: Form | null | undefined
): void => sn.UnregisterForSkillIncrease(akForm);
...
export const RegisterForSoulTrapped = (akForm: Form | null | undefined): void =>
  sn.RegisterForSoulTrapped(akForm);
export const UnregisterForSoulTrapped = (
  akForm: Form | null | undefined
): void => sn.UnregisterForSoulTrapped(akForm);
...
export const RegisterForSpellLearned = (
  akForm: Form | null | undefined
): void => sn.RegisterForSpellLearned(akForm);
export const UnregisterForSpellLearned = (
  akForm: Form | null | undefined
): void => sn.UnregisterForSpellLearned(akForm);
...
export const RegisterForWeatherChange = (
  akForm: Form | null | undefined
): void => sn.RegisterForWeatherChange(akForm);
export const UnregisterForWeatherChange = (
  akForm: Form | null | undefined
): void => sn.UnregisterForWeatherChange(akForm);
...
export const RegisterForFECReset = (
  akForm: Form | null | undefined,
  aiType: number
): void => sn.RegisterForFECReset(akForm, aiType);
export const UnregisterForFECReset = (
  akForm: Form | null | undefined,
  aiType: number
): void => sn.UnregisterForFECReset(akForm, aiType);
export const UnregisterForAllFECResets = (
  akForm: Form | null | undefined
): void => sn.UnregisterForAllFECResets(akForm);
