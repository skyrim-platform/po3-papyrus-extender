...
): void => sn.RegisterForActorKilled(akAlias);
export const UnregisterForActorKilled = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForActorKilled(akAlias);
...
export const RegisterForActorReanimateStart = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForActorReanimateStart(akAlias);
export const UnregisterForActorReanimateStart = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForActorReanimateStart(akAlias);

export const RegisterForActorReanimateStop = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForActorReanimateStop(akAlias);
export const UnregisterForActorReanimateStop = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForActorReanimateStop(akAlias);
...
export const RegisterForActorResurrected = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForActorResurrected(akAlias);
export const UnregisterForActorResurrected = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForActorResurrected(akAlias);
...
export const RegisterForBookRead = (akAlias: Alias | null | undefined): void =>
  sn.RegisterForBookRead(akAlias);
export const UnregisterForBookRead = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForBookRead(akAlias);
...
export const RegisterForCellFullyLoaded = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForCellFullyLoaded(akAlias);
export const UnregisterForCellFullyLoaded = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForCellFullyLoaded(akAlias);
...
export const RegisterForCriticalHit = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForCriticalHit(akAlias);
export const UnregisterForCriticalHit = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForCriticalHit(akAlias);
...
export const RegisterForDisarmed = (akAlias: Alias | null | undefined): void =>
  sn.RegisterForDisarmed(akAlias);
export const UnregisterForDisarmed = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForDisarmed(akAlias);
...
export const RegisterForDragonSoulGained = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForDragonSoulGained(akAlias);
export const UnregisterForDragonSoulGained = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForDragonSoulGained(akAlias);
...
export const RegisterForItemHarvested = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForItemHarvested(akAlias);
export const UnregisterForItemHarvested = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForItemHarvested(akAlias);
...
export const RegisterForLevelIncrease = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForLevelIncrease(akAlias);
export const UnregisterForLevelIncrease = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForLevelIncrease(akAlias);
...
export const RegisterForLocationDiscovery = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForLocationDiscovery(akAlias);
export const UnregisterForLocationDiscovery = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForLocationDiscovery(akAlias);
...
export const RegisterForObjectGrab = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForObjectGrab(akAlias);
export const UnregisterForObjectGrab = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForObjectGrab(akAlias);
...
export const RegisterForObjectLoaded = (
  akAlias: Alias | null | undefined,
  formType: number
): void => sn.RegisterForObjectLoaded(akAlias, formType);
export const UnregisterForObjectLoaded = (
  akAlias: Alias | null | undefined,
  formType: number
): void => sn.UnregisterForObjectLoaded(akAlias, formType);
export const UnregisterForAllObjectsLoaded = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForAllObjectsLoaded(akAlias);
...
): void => sn.RegisterForQuest(akAlias, akQuest);
export const UnregisterForQuest = (
  akAlias: Alias | null | undefined,
  akQuest: Quest | null | undefined
): void => sn.UnregisterForQuest(akAlias, akQuest);
export const UnregisterForAllQuests = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForAllQuests(akAlias);
...
export const RegisterForQuestStage = (
  akAlias: Alias | null | undefined,
  akQuest: Quest | null | undefined
): void => sn.RegisterForQuestStage(akAlias, akQuest);
export const UnregisterForQuestStage = (
  akAlias: Alias | null | undefined,
  akQuest: Quest | null | undefined
): void => sn.UnregisterForQuestStage(akAlias, akQuest);
export const UnregisterForAllQuestStages = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForAllQuestStages(akAlias);
...
export const RegisterForShoutAttack = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForShoutAttack(akAlias);
export const UnregisterForShoutAttack = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForShoutAttack(akAlias);
...
export const RegisterForSkillIncrease = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForSkillIncrease(akAlias);
export const UnregisterForSkillIncrease = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForSkillIncrease(akAlias);
...
export const RegisterForSoulTrapped = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForSoulTrapped(akAlias);
export const UnregisterForSoulTrapped = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForSoulTrapped(akAlias);
...
export const RegisterForSpellLearned = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForSpellLearned(akAlias);
export const UnregisterForSpellLearned = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForSpellLearned(akAlias);
...
export const RegisterForWeatherChange = (
  akAlias: Alias | null | undefined
): void => sn.RegisterForWeatherChange(akAlias);
export const UnregisterForWeatherChange = (
  akAlias: Alias | null | undefined
): void => sn.UnregisterForWeatherChange(akAlias);
...
export const RegisterForMagicEffectApplyEx = (
  akRefAlias: ReferenceAlias | null | undefined,
  akEffectFilter: Form | null | undefined,
  abMatch: boolean
): void =>
  sn.RegisterForMagicEffectApplyEx(akRefAlias, akEffectFilter, abMatch);
export const UnregisterForMagicEffectApplyEx = (
  akRefAlias: ReferenceAlias | null | undefined,
  akEffectFilter: Form | null | undefined,
  abMatch: boolean
): void =>
  sn.UnregisterForMagicEffectApplyEx(akRefAlias, akEffectFilter, abMatch);
export const UnregisterForAllMagicEffectApplyEx = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.UnregisterForAllMagicEffectApplyEx(akRefAlias);
...
export const RegisterForWeaponHit = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.RegisterForWeaponHit(akRefAlias);
export const UnregisterForWeaponHit = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.UnregisterForWeaponHit(akRefAlias);
...
export const RegisterForMagicHit = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.RegisterForMagicHit(akRefAlias);
export const UnregisterForMagicHit = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.UnregisterForMagicHit(akRefAlias);
...
export const RegisterForProjectileHit = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.RegisterForProjectileHit(akRefAlias);
export const UnregisterForProjectileHit = (
  akRefAlias: ReferenceAlias | null | undefined
): void => sn.UnregisterForProjectileHit(akRefAlias);
